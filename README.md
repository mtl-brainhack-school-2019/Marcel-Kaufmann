...
* Anaconda ![Anaconda](https://upload.wikimedia.org/wikipedia/en/c/cd/Anaconda_Logo.png | width = 100)
* Docker ![Docker](https://www.docker.com/sites/default/files/d8/styles/role_icon/public/2019-07/vertical-logo-monochromatic.png?itok=erja9lKc | width=100)
* Pandas
* NeuroKit
* Ipython Notebooks
